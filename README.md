...
sequenceDiagram
    ...
    participant JVM
    participant Aluno
    Main->>JVM: new Aluno("Maria", 20, "Informatica")
    JVM->>Aluno: aloca memoria
    JVM->>Aluno: chama construtor
    Aluno->>Aluno: this.nome = "Maria"
    Aluno->>Aluno: this.idade = 20
    Aluno->>Aluno: this.curso = "Informatica"
    JVM-->>Main: retorna referencia ao objeto
```
...
classDiagram
    ...
    class Notificavel {
        <<interface>>
        +enviarEmail(String) void
        +enviarSMS(String) void
        +notificarTodos(String, String) void
    }
    Imprimivel <|.. Relatorio
    Notificavel <|.. Relatorio
    class Relatorio {
        -String titulo
        -String conteudo
        +imprimir() void
